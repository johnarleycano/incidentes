...
function pickDate(e,inputDay)
{
	...
	if(returnFormat){
		...
		if(isNaN(parseInt(currentHour))==true)
			returnFormat = returnFormat.replace('hh','00');
		else
		if(parseInt(currentHour)<10)
			returnFormat = returnFormat.replace('hh','0'+parseInt(currentHour));
		else
			returnFormat = returnFormat.replace('hh',currentHour);

			
		if(isNaN(parseInt(currentMinute))==true)
			returnFormat = returnFormat.replace('ii','00:00');
		else
		if(parseInt(currentMinute)<10)
			returnFormat = returnFormat.replace('ii','0'+parseInt(currentMinute)+':00');
		else
			returnFormat = returnFormat.replace('ii',currentMinute+':00');
