...
function tpear()
{
include_once('../../../Copy of pruebas/adodb/tests/DB.php');
...
function tadodb()
{
include_once('../../../Copy of pruebas/adodb/adodb.inc.php');
...
?>
<a href=../../../Copy of pruebas/adodb/tests/tmssql.php?do=tmssql>mssql</a>
<a href=../../../Copy of pruebas/adodb/tests/tmssql.php?do=tpear>pear</a>
<a href=../../../Copy of pruebas/adodb/tests/tmssql.php?do=tadodb>adodb</a>
<?php
if (!empty($_GET['do'])) {
	$do = $_GET['do'];
	$do();
