...
include_once('../../../Copy of pruebas/adodb/adodb-pear.inc.php');
//--------------------------------------------------------------------------------------
...
global $ADODB_EXTENSION;
	...
	include_once('../../../Copy of pruebas/adodb/session/adodb-session.php');
...
*/		
 ...
 //	$db->debug=true;
	...
	print "<p>Test CSV</p>";
	include_once('../../../Copy of pruebas/adodb/toexport.inc.php');
	//$ADODB_FETCH_MODE = ADODB_FETCH_ASSOC;
	...
	/////////////////////////////////////////////////////////////
	include_once('../../../Copy of pruebas/adodb/pivottable.inc.php');
...
include("../../../Copy of pruebas/adodb/tohtml.inc.php");
include("../../../Copy of pruebas/adodb/adodb.inc.php");
include("../../../Copy of pruebas/adodb/rsfilter.inc.php");
...
Test <a href=../../../Copy of pruebas/adodb/tests/test4.php>GetInsertSQL/GetUpdateSQL</a> &nbsp; 
	<a href=../../../Copy of pruebas/adodb/tests/testsessions.php>Sessions</a> &nbsp;
	<a href=../../../Copy of pruebas/adodb/tests/testpaging.php>Paging</a> &nbsp;
	<a href=../../../Copy of pruebas/adodb/tests/test-perf.php>Perf Monitor</a><p>
<?php
include('../../../Copy of pruebas/adodb/tests/testdatabases.inc.php');
?>
	
<?php

include_once('../../../Copy of pruebas/adodb/adodb-time.inc.php');
adodb_date_test();
?>
