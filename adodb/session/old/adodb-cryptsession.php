...
wrapper library.
 ...
 =======
	...
	include('../../../../Copy of pruebas/adodb/session/old/adodb.inc.php');
	#---------------------------------#
	include('../../../../Copy of pruebas/adodb/session/old/adodb-cryptsession.php'); 
	#---------------------------------#
	session_start();
...
include_once('../../../../Copy of pruebas/adodb/session/old/crypt.inc.php');
