...
<link href="/pag/css/estilos.css" rel="stylesheet" type="text/css" />
<script>
...
<tr>
<td><img src="/pag/img/se_v.png" /></td><td align="left">Via sin ningún tipo de problema en su recorrido.</td>
<td><img src="/pag/img/se_a.png" /></td><td align="left">Via con alguna restricción en su recorrido.</td>
<td><img src="/pag/img/se_r.png" /></td><td align="left">Via que presenta problemas en su recorrido.</td></tr>
...
if($rs->NumRows()==0)
	...
	<td ><img src='/pag/img/se_v.png'></td>
	<td >&nbsp;</td>
	<td >".date('d-m-Y')."</td>
	<td >".date('H:i')."</td>
	<td >&nbsp;</td>
...
while (!$rs->EOF) {
	...
	echo "<td ><img src='/pag/img/se_".$rs->fields[7].".png'></td>";	
