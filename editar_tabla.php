...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		if(isset($_POST['accion']) && $_POST['accion']=='E'){
			...
			$sql="DELETE FROM ".$_SESSION[APL]->bd->nombre_bd[0].".".$tabla_rs." WHERE id=?";
		...
		} else if(isset($_POST['accion']) && $_POST['accion']=='A') {
			if($tabla_rs=='dvm_referencia') {
				...
				$sql=
				"UPDATE ".$_SESSION[APL]->bd->nombre_bd[0].".".$tabla_rs." SET
				id_via=?,
				abscisa=?,
				margen=?,
				referencia=?,
		...
		} else if(isset($_POST['accion']) && $_POST['accion']=='N') {
		...
		} else if(isset($_POST['accion']) && $_POST['accion']=='ACTMAS') {
			if($tabla_rs=='dvm_referencia') {
