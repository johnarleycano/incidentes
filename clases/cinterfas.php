	...
	function pestana($id_actual){
		...
		else
		{
			...
			if($_SESSION[APL]->usuario->id_perfil==2)
			{
				...
				$titulo[4] = "Reportes";
				$titulo[5] = "Bitacora";
				$enlace[5] = $rutImg."bitacoras/bitacoras.php";
			}
			if($_SESSION[APL]->usuario->id_perfil==3)
			{
				$titulo[2] = "Registro SOS";
			...
			if($_SESSION[APL]->usuario->id_perfil==0)
			{
				...
				$titulo[7] = "Bitacora";
				$enlace[7] = $rutImg."bitacoras/bitacoras.php";
			}*/
			...
			if($_SESSION[APL]->usuario->id_perfil==2)
			{
				$enlace[2] = $rutImg."registro_bitacoras.php";//radicado
				$titulo[2] = "Registro Bit&aacute;coras";
				$enlace[3] = $rutImg."registro_inicial.php";//radicado
				$titulo[3] = "Registro Inicial";
				$titulo[4] = "Registro SOS";
				$enlace[4] = $rutImg."registro_sos/registro_sos.php";
				$enlace[5] = $rutImg."reportes.php";
				$titulo[5] = "Reportes";
				$titulo[6] = "Bit&aacute;coras";
				$enlace[6] = $rutImg."bitacoras/bitacoras.php";
			}
			if($_SESSION[APL]->usuario->id_perfil==3)
			{
				
				$titulo[2] = "Registro Adm Vial";
				$enlace[2] = $rutImg."registro_vial/registro_vial.php";
				$titulo[3] = "Registro SOS";
				$enlace[3] = $rutImg."registro_sos/registro_sos.php";
				$enlace[4] = $rutImg."reportes.php";
				$titulo[4] = "Reportes";
			...
			if($_SESSION[APL]->usuario->id_perfil==0)
			{
				...
				$titulo[4] = "Registro SOS";
				$enlace[4] = $rutImg."registro_sos/registro_sos.php";
				$titulo[5] = "Registro Adm Vial";
				$enlace[5] = $rutImg."registro_vial/registro_vial.php";
				$enlace[6] = $rutImg."reportes.php";
				$titulo[6] = "Reportes";
				$titulo[7] = "Parametros";
				$enlace[7] = $rutImg."parametrizacion.php";
				$titulo[8] = "Bit&aacute;coras";
				$enlace[8] = $rutImg."bitacoras/bitacoras.php";
			}
		}
		...
		$dumy .= '</tr>
		<tr><td colspan="'.($colsp+1).'"  align="right"><b>Usuario actual:</b> '.$_SESSION[APL]->usuario->nombres.' '.$_SESSION[APL]->usuario->apellidos.' | <b>Versi&oacute;n: </b>'.$_SESSION[APL]->obtenerVersion().'</td></tr>
		</table></center>';
